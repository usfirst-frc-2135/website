...
<div class="container" role="main">
  ...
  <div class="row p-2">
    ...
    <div class="fst-italic m-0 mb-3">
      <h5>
        Presented by Haas, the game is themed around music and concerts as part of the overall 2023-24 FIRST in Show season.
      </h5>
      <hr>
    </div>
    ...
    <div class="row bg-light m-0 mb-3">
      ...
      <div>
        <img class="img-fluid" width="880" src="img/first_2024-crescendo/crescendo_field.jpg" alt="Crescendo field">
      </div>
    </div>
    ...
    <div class="row m-0 mb-3">
      ...
      <div>
        <img class="img-fluid" width="880" src="img/first_2024-crescendo/crescendo_field_3d.png" alt="Crescendo 3D field">
      </div>
    </div>
